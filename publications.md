...
<main class="site-main">
  ...
  <div class="pub-year-group">
    ...
    <div class="pub-card" id="smartcookie">
      ...
      <div class="pub-figure">
        <img src="/assets/img/papers/smartcookie.jpg" alt="SmartCookie architecture: split-proxy P4 switch + software proxy">
      </div>
      <div class="pub-links">
        ...
        <a href="/documents/SmartCookie_Artifact_USENIXSec24.pdf"
           class="pub-link" target="_blank" rel="noopener">Artifact Appendix</a>
        ...
        <a href="https://www.youtube.com/embed/oNi_4wCo9Gg?si=2YLaf0dpxxprv_WW"
           class="pub-link" target="_blank" rel="noopener">Live Demo Video</a>
        <a href="https://github.com/Princeton-Cabernet/p4-projects/tree/master/SmartCookie"
           class="pub-link" target="_blank" rel="noopener">P4 Code (GitHub)</a>
      </div>
    ...
    <div class="pub-card" id="tango">
      ...
      <div class="pub-figure">
        <img src="/assets/img/papers/tango.jpg" alt="TANGO collaborative route control: cooperating ASes selecting safe BGP paths">
      </div>
      <div class="pub-links">
    ...
    <div class="pub-card" id="sieve">
      ...
      <div class="pub-links">
        ...
        <a href="/documents/Sieve_Slides_P4Workshop23.pptx"
           class="pub-link" target="_blank" rel="noopener">Slides (PPTX)</a>
      </div>
    </div>
  </div>
  ...
  <div class="pub-year-group">
    ...
    <div class="pub-card" id="smartcookie-poster">
      ...
      <div class="pub-links">
        <a href="/documents/SmartCookie_Poster_Princeton22.pdf"
           class="pub-link" target="_blank" rel="noopener">Poster (PDF)</a>
        <a href="/documents/SmartCookie_Slides_Princeton22.pptx"
           class="pub-link" target="_blank" rel="noopener">Slides (PPTX)</a>
        <a href="https://www.youtube.com/embed/wRDvL_lwB9M?si=jndpA4al-mpTkYRh"
           class="pub-link" target="_blank" rel="noopener">Video</a>
        <a href="https://github.com/Princeton-Cabernet/p4-projects/tree/master/SmartCookie"
           class="pub-link" target="_blank" rel="noopener">P4 Code (GitHub)</a>
      </div>
    ...
    <div class="pub-card" id="siphash">
      ...
      <div class="pub-links">
        <a href="/documents/SipID_Paper_SPIN21.pdf"
           class="pub-link" target="_blank" rel="noopener">Paper (PDF)</a>
        <a href="/documents/SipID_Slides_SPIN21.pptx"
           class="pub-link" target="_blank" rel="noopener">Slides (PPTX)</a>
        <a href="https://www.youtube.com/embed/Zf-_XKFngJ8"
           class="pub-link" target="_blank" rel="noopener">Video</a>
        <a href="https://github.com/Princeton-Cabernet/p4-projects/tree/master/SipHash-tofino"
           class="pub-link" target="_blank" rel="noopener">P4 Code (GitHub)</a>
      </div>
    </div>
  </div>
